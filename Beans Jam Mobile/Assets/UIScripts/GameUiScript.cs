...
public class GameUiScript : MonoBehaviour
{
	...
	void Start()
	{
		...
		timingsList2 = new Queue<string>(new[] { "0:01:84-0:02:61","0:04:53","0:05:44-0:06:22","0:08:13","0:09:03-0:09:75","0:12:63-0:13:36","0:17:11","0:17:71",
						"0:18:03","0:18:91","0:20:71","0:21:34","0:21:64","0:22:55-0:23:77","0:24:32","0:24:92","0:25:25","0:26:11","0:27:03","0:27:34","0:27:65","0:28:81",
						"0:29:71","0:30:61-0:31:33","0:33:30","0:33:93","0:34:24","0:36:89","0:37:83-0:38:68","0:40:51","0:41:12","0:41:34","0:44:10-0:44:98","0:45:04-0:45:87",
						"0:46:84-0:47:67","0:48:64-0:49:59","0:50:39","0:51:03","0:51:36","0:51:92","0:52:23-0:53:29","0:54:02-0:55:34","0:55:81-0:56:78","0:57:64","0:58:52",
						"0:59:41-1:00:27" });

		timeStamps = new Queue<TimeStamp>();

		noteList = new List<GameObject>();
		noteList.Add(notePrefab);
		noteList.Add(notePrefab1);
		noteList.Add(notePrefab2);
	...
	void Update()
	{
		...
		{
			if (_timer != null && _timer.ElapsedMilliseconds + _timeOffsetMilliseconds >= timeStamps.Peek().getMilliseconds())
			{
